...
export const fakeGitHubReleases: GitHubRelease[] = [
  {
    ...
    draft: false,
    prerelease: false,
    html_url: 'https://github.com/BrainBehaviorAnalyticsLab/voxkit-desktop/releases/tag/v1.3.0',
  ...
  },
  {
    ...
    draft: false,
    prerelease: false,
    html_url: 'https://github.com/BrainBehaviorAnalyticsLab/voxkit-desktop/releases/tag/v1.2.0',
  ...
  },
  {
    ...
    draft: false,
    prerelease: true,
    html_url: 'https://github.com/BrainBehaviorAnalyticsLab/voxkit-desktop/releases/tag/v0.9.0',
    body: 'Early preview.',
    assets: [
      {
