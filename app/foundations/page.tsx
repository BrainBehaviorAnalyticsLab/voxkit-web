      ...
      <div className="pt-32 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            VoxKit acts on (and interprets) findings from key research studies
            in speech pathology to{" "}
            <span className="text-blue-300">support research teams</span> and{" "}
            <span className="text-blue-300">reduce technical barriers</span>.
          </p>
        </div>
