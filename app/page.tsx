...
export default function VoxKitLanding() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Got existing datasets? Bring them. VoxKit plays nice with what you've already built. No reformatting marathons required.",
    },
    {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-600 border rounded-xl p-12 text-center shadow-xl shadow-black/20 tile">
            ...
            <p className="text-lg text-slate-100 max-w-3xl mx-auto mb-8">
              You&apos;re not getting some watered-down toy. VoxKit wraps
              battle-tested tools like Montreal Forced Aligner (MFA) in a
              friendly interface. Same powerful algorithms the big labs use,
              minus the command-line gymnastics.
            </p>
