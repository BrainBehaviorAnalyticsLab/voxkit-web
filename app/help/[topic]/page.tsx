    ...
    switch (section.type) {
      ...
      case "heading":
        return (
          <h2
            key={index}
            className="text-2xl font-bold text-white mt-10 mb-4 flex items-center"
          >
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <div className="pt-24 pb-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-center mb-4">
            ...
            <div>
              ...
              <p className="text-xl text-slate-400">{helpTopic.description}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-slate-700 shadow-2xl mb-12">
          {helpTopic.sections.map((section, index) =>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="font-medium">
                    {typedHelpContent[previousTopic].title}
                  </div>
                </div>
              </Link>
            )}
            ...
            {nextTopic && (
              ...
              >
                <div className="text-right">
                  ...
                  <div className="font-medium">
                    {typedHelpContent[nextTopic].title}
                  </div>
                </div>
                <svg
        ...
        <div className="mt-12 p-6 bg-blue-900/20 border border-blue-800/30 rounded-xl">
          <div className="grid md:grid-cols-3 gap-4 text-sm ">
            <a
              href="https://github.com/BrainBehaviorAnalyticsLab/voxkit-desktop/issues"
              className="text-slate-300 hover:text-white transition-colors flex items-center justify-center"
            >
              <svg
                className="w-4 h-4 mr-2"
                fill="currentColor"
