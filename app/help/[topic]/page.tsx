    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <div className="pt-24 pb-16 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 p-6 bg-blue-900/20 border border-blue-800/30 rounded-xl">
          <h3 className="text-lg font-semibold mb-3 text-blue-300">Need More Help?</h3>
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <a href="https://github.com/BrainBehaviorAnalyticsLab/voxkit" className="text-slate-300 hover:text-white transition-colors flex items-center">
            ...
            <a href="mailto:support@voxkit.dev" className="text-slate-300 hover:text-white transition-colors flex items-center">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
