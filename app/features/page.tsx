      ...
      <div className="pt-32 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Enabling cross-functional teams to conduct phonetic research with
            ease.
          </p>
        </div>
        ...
        <div className="mb-20 bg-gradient-to-r from-slate-800/80 to-slate-700/80 backdrop-blur-sm border border-slate-500 rounded-2xl p-10 tile">
          ...
          <p className="text-lg text-slate-200 text-center max-w-4xl mx-auto leading-relaxed">
            To accelerate discovery and improve care in speech-language
            pathology by providing an intuitive, transparent platform for
            advanced forced alignment, pronunciation assessment, and phonetic
            research. Accessible to every researcher, not just programmers.
          </p>
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto">
              VoxKit&apos;s modular api enables seamless integration of speech
              processing engines (toolkits), from established libraries at the
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto">
              Multi-step capabilities for common research tasks, from model
              training to alignment generation and pronunciation assessment.
              Stackers are ordered, added and removed to build custom pipelines.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {stackers.map((stacker, index) => (
              <div
                ...
                className="bg-slate-800/50 backdrop-blur-sm border border-slate-600 rounded-xl p-8 transition-all tile"
              >
                <div className="text-cyan-400 mb-4">{stacker.icon}</div>
                <h3 className="text-xl font-semibold mb-3 text-white">
                  {stacker.name}
                </h3>
                <p className="text-slate-200 mb-4 leading-relaxed">
        ...
        <div className="mb-20">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto">
              ...
              enabling quality assurance and a tailored method of visualization.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-600 rounded-xl p-8 transition-all tile">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-slate-200">
            <div>
              ...
              <p>
                Graphical interface eliminates command-line barriers while
                maintaining full control over analysis parameters and model
                configurations.
              </p>
            </div>
            <div>
              ...
              <p>
                Extensible architecture with well-documented APIs enables
                integration of proprietary tools and custom analysis pipelines.
              </p>
            </div>
          </div>
        </div>
